      ...
      results: [
        {
          ...
          type: "X_CREATE_ASSET_TRANSACTION",
          ...
          inputs: [
            {
              output: {
                ...
                amount: "100000000",
                addresses: ["X-avax150agl543yn0n5z9z20tgmrggs8fc2ckkma4qfv"]
              }
            }
          ],
          outputs: [
          ...
          inputs: [
            {
              output: {
                ...
                assetID: "FvwEAhmxKfeiG8SnEvq42hc6whRyY3EFYAvebMqDNDGCgxN5Z",
                amount: "1000000",
                addresses: ["X-avax1xasw9kra42luktrckgc8z3hsgzme7h4ck6r4s9"]
              }
            },
            {
              output: {
  ...
  outputs: [
    {
      ...
      assetID: 'FvwEAhmxKfeiG8SnEvq42hc6whRyY3EFYAvebMqDNDGCgxN5Z',
      addresses: ['X-avax1dcv9jg4x9z3drxxkgjs70eh0lgff9qyymq7wx8'],
      outputType: 7,
      amount: 82000000,
      isValidAsset: false,
      isUserAddress: false
